...
<body>
    ...
    <div class="login-clean">
        <form method="post">
            ...
            <div class="illustration"><i class="far fa-user" style="color: #0072c6;"></i></div>
            <div class="form-group"><input class="form-control" type="text" name="mobile" placeholder="Mobile"></div>
            <div class="form-group"><input class="form-control" type="password" name="password" placeholder="Password"></div>
            <div class="form-group"><a href="forget_password.php">&nbsp;Forget Password ?</a></div>
            <div class="form-group"><button class="btn btn-primary btn-block" type="submit" name="submit" style="background-color: #0072c6;">Log In</button></div><a class="text-capitalize forgot" href="register.php" style="font-size: 15px;">Sign up from here </a></form>
    </div>
...
if (isset($_POST['submit'])) {
    $login->login($_POST['mobile'],$_POST['password'],$_SESSION['event'],$_SESSION['date'],$_SESSION['hall'],$_SESSION['start_time'],$_SESSION['end_time']);
}
