                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4">
                        <div class="card border-0"><a href="#"><img src="assets/img/Birthday3.jpg" alt="Card Image" class="card-img-top scale-on-hover"></a>
                            <div class="card-body">
                                <h6><a href="#">Hall Name , Location</a></h6>
                                <p class="text-muted card-text">Description : Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc quam urna.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="card border-0"><a href="#"><img src="assets/img/Birthday6.jpg" alt="Card Image" class="card-img-top scale-on-hover"></a>
                            <div class="card-body">
                                <h6><a href="#">Hall Name , Location</a></h6>
                                <p class="text-muted card-text">Description : Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc quam urna.<br></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card border-0"><a href="#"><img src="assets/img/smhall6.jpg" alt="Card Image" class="card-img-top scale-on-hover"></a>
                            <div class="card-body">
                                <h6><a href="#">Hall Name , Location</a></h6>
                                <p class="text-muted card-text">Description : Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc quam urna.<br></p>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card border-0"><a href="#"><img src="assets/img/whall3.jpg" alt="Card Image" class="card-img-top scale-on-hover"></a>
                            <div class="card-body">
                                <h6><a href="#">Hall Name , Location</a></h6>
                                <p class="text-muted card-text">Description : Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc quam urna.<br></p>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card border-0"><a href="#"><img src="assets/img/smhall3.jpg" alt="Card Image" class="card-img-top scale-on-hover"></a>
                            <div class="card-body">
                                <h6><a href="#">Hall Name , &nbsp;Location</a></h6>
                                <p class="text-muted card-text">Description : Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc quam urna.<br></p>
                            </div>
