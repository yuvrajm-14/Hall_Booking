    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link collapsed" href="#navbar-hall" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-hall">
              <i class="ni ni-building text-blue"></i>
              <span class="nav-link-text">Halls</span>
            </a>
            <div class="collapse" id="navbar-hall" style="">
              <ul class="nav nav-sm flex-column">
                <li class="nav-item">
                  <a href="admin_add_hall.php" class="nav-link">
                    <i class="ni ni-bullet-list-67 text-blue"></i>
                    <span class="sidenav-normal"> Add Hall</span>
                  </a>
                </li>

                <li class="nav-item">
                  <a href="admin_show_hall.php" class="nav-link">
                    <i class="ni ni-bullet-list-67 text-blue"></i>
                    <span class="sidenav-normal"> View Hall</span>
                  </a>
                </li>
          ...
          <li class="nav-item  active ">
            <a class="nav-link " href="admin_show_hall_owners.php">
              <i class="ni ni-single-02 text-primary"></i> Hall Owners
            </a>
          </li>

          <li class="nav-item  active ">
            <a class="nav-link " href="admin_view_booking.php">
              <i class="ni ni-tag text-primary"></i> Bookings
            </a>
          </li>

          <li class="nav-item  active ">
            <a class="nav-link " href="admin_view_staff.php">
              <i class="ni ni-circle-08 text-primary"></i> Staff
            </a>
          </li>

          <li class="nav-item  active ">
            <a class="nav-link " href="admin_show_messages.php">
          ...
          <!-- <li class="nav-item">
            <a class="nav-link collapsed" href="#navbar-sales" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-sales">
            ...
            <div class="collapse" id="navbar-sales" style="">
              <ul class="nav nav-sm flex-column">
                <li class="nav-item">
                  <a href="admin_add_sale.php" class="nav-link">
                    <i class="ni ni-bullet-list-67 text-blue"></i>
                ...
                <li class="nav-item">
                  <a href="admin_show_sale.php" class="nav-link">
                    <i class="ni ni-bullet-list-67 text-blue"></i>
                    <span class="sidenav-normal"> View Sales </span>
                  </a>
                </li>
