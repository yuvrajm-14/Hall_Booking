<?php 
include('session/owner_session.php');
      ...
      <ul class="nav align-items-center d-md-none">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
            ...
            <div class="dropdown-divider"></div>
            <a href="owner_logout.php" class="dropdown-item">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item  active ">
            <a class="nav-link  active " href="owner_edit_hall.php?id=<?php echo $_SESSION['owner']; ?>">
              <i class="ni ni-building text-primary"></i> Edit Hall
            </a>
          </li>

          <li class="nav-item  active ">
            <a class="nav-link  active " href="owner_view_booking.php?id=<?php echo $_SESSION['owner']; ?>">
              <i class="ni ni-credit-card text-primary"></i> Bookings
            </a>
          </li>

          <!-- <li class="nav-item  active ">
            <a class="nav-link  active " href="owner_view_staff.php?id=<?php echo $_SESSION['owner']; ?>">
              <i class="ni ni-credit-card text-primary"></i> Staff
            </a>
          </li> -->
          ...
          <li class="nav-item  active ">
            <a class="nav-link  active " href="owner_logout.php">
