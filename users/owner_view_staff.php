...
$staffs=new owner;
$show_staffs=$staffs->show_all_staff($_SESSION['owner']);
                      ...
                      <td class="text-right">
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                            <a class="dropdown-item" href="owner_edit_staff.php?id=<?php echo $show_staff['id']; ?>">View</a>
                            <a class="dropdown-item" onclick="return confirm('Are you sure to delete this staff ?');" href="owner_delete_staff.php?id=<?php echo $show_staff['id']; ?>">Delete</a>
