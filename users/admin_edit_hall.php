                        ...
                        <div class="row">
                          ...
                          <div class="col-12">
                            <div class="form-group focused">
                              ...
                              <textarea class="form-control form-control-alternative" placeholder="Description" name="description" cols="5"><?php echo $hall['description']; ?></textarea>
                            </div>
                          </div>
...
if (isset($_POST['submit'])) {
  ...
  $stmt=mysqli_query($con,"UPDATE `hall` SET `name` = '".$_POST['name']."', `description` = '".$_POST['description']."', `address` = '".$_POST['address']."', `location` = '".$_POST['location']."', `capacity` = '".$_POST['capacity']."', `status` = '".$_POST['status']."', `owner_name` = '".$_POST['owner_name']."', `owner_username` = '".$_POST['owner_username']."', `owner_password` = '".$_POST['owner_password']."' WHERE `hall`.`id` = '".$_GET['id']."'");
      if ($stmt==TRUE) {
