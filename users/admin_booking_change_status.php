...
<div class="container">
    ...
    <div class="row my-4">
        ...
        <div class="col-12 my-3">
            ...
            <input class="form-control" type="text" readonly="" value="<?php echo $user_info['name']. " | ".$user_info['mobile'] ; ?>" >
        ...
        <div class="col-4">
            ...
            <input class="form-control" type="text" name="paid_amount" readonly="" placeholder="Paid Amount" value="<?php echo $booking['paid_amount']; ?>" required="">
                            
        </div>
        <div class="col-12">
            <label for="subject">More Details *</label>
            <textarea class="form-control" name="more_details" readonly="" rows="5"><?php echo $booking['more_details']; ?></textarea>
        </div>
    </div>
    <!-- <div class="row mb-5">
