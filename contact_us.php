        ...
        <section class="portfolio-block hire-me">
            <div class="container">
                ...
                <form method="post">
                    ...
                    <div class="form-group"><label for="mobile">Mobile *</label><input class="form-control" required="" type="text" name="mobile" id="mobile"></div>
                    <div class="form-group"><label for="message">Message</label><textarea class="form-control" required="" name="message" id="message"></textarea></div>
                    <div class="form-group">
                        <div class="form-row">
                            <div class="col-md-6 button"><button class="btn btn-primary btn-block" name="submit" type="submit">Submit</button></div>
                        </div>
                    </div>
                </form>
            </div>
...
<?php if (isset($_POST['submit'])) {
    $contact->contact_message_submit($_POST['email'],$_POST['mobile'],$_POST['message']);
} ?>