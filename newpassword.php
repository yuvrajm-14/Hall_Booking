...
<body>
    ...
    <div class="login-clean">
        <form method="post">
            ...
            <div class="form-group"><input class="form-control" name="password" type="text" placeholder="New Password"></div>
...
if (isset($_POST['submit'])) {
    $forget->update_password($_SESSION['otp_mobile'],$_POST['password']);
}
