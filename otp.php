...
<body>
    ...
    <div class="login-clean">
        <form method="post">
            ...
            <div class="form-group"><input class="form-control" name="otp" type="text" placeholder="Enter OTP"></div>
            <div class="form-group"><button class="btn btn-primary btn-block" name="submit" type="submit" style="background-color: #0072c6;">Submit</button></div>
        </form>
    </div>
...
if (isset($_POST['submit'])) {
    ...
    ?>
        <script type="text/javascript">
            // alert('done');
            window.open('newpassword.php','_self');
        </script>
    <?php
    }else{
    ?>
        <script type="text/javascript">
            alert('Wrong OTP please check otp again.');
        </script>
    <?php
    }
}
